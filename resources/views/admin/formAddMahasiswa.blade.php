...
<form>
  <div class="flex flex-col justify-between">
    ...
    <button class="rounded-full py-2 px-3 uppercase text-xs font-bold cursor-pointer tracking-wider text-green-800 bg-green-200 W-100 mt-5" id="store_location">
      Simpan
    </button>
  </div>
</form>
