  ...
  <table class="w-full">
    <thead class="bg-gray-50 border-b-2 border-gray-200">
      <tr>
        ...
        <th class="p-3 text-sm font-semibold tracking-wide text-left">Kode Kelas</th>
    ...
    <tbody class="divide-y divide-gray-100">
      ...
      <tr class="odd:bg-white even:bg-gray-50">
        ...
        <td class="p-3 text-sm text-gray-700 whitespace-nowrap"> {{$user->kd_kelas}}</td>
        <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
          <div class="text-center flex items-center">
            <a href="{{ url('Kelas/edit/'.$user->id) }}"
            ...
            <form action="{{ url('Kelas/'.$user->id) }}" method="post">
              @method('delete')
              @csrf
              <button
